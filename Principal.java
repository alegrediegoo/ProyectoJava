...
public class Principal extends JFrame implements ActionListener{
    ...
    private JMenuItem miCalculo,miAzul,miLila,miVerde,miElCreador,miSalir,miNuevo;
    ...
    public Principal() {
      ...
      getContentPane().setBackground(new Color(33,154,201));
      setIconImage(new ImageIcon(getClass().getResource("images/icono.png")).getImage());
      Bienvenida panelBienvenida = new Bienvenida();
      nombreAdmin = panelBienvenida.alegre;

      mb = new JMenuBar();
      mb.setBackground(new Color(33, 154, 201));
      setJMenuBar(mb);

      menuOpciones = new JMenu("Opciones");
      menuOpciones.setBackground(new Color(255, 255, 255));
      menuOpciones.setFont(new Font("Andale Mono", 1, 14));
      menuOpciones.setForeground(new Color(13, 36, 63));
      mb.add(menuOpciones);

      menuCalcular = new JMenu("Calcular");
      menuCalcular.setBackground(new Color(255, 255, 255));
      menuCalcular.setFont(new Font("Andale Mono", 1, 14));
      menuCalcular.setForeground(new Color(13, 36, 63));
      mb.add(menuCalcular);

      menuAcercaDe = new JMenu("Acerca de");
      menuAcercaDe.setBackground(new Color(255, 255, 255));
      menuAcercaDe.setFont(new Font("Andale Mono", 1, 14));
      menuAcercaDe.setForeground(new Color(13, 36, 63));
      mb.add(menuAcercaDe);
      ...
      miLila.setFont(new Font("Andale Mono", 1, 14));
      miLila.setForeground(new Color(0, 0, 0));
      menuColorFondo.add(miLila);
      ...
      labelLogo.setBounds(5,5,200,100);
      add(labelLogo);

      labelBienvenido = new JLabel("Bienvenido " + nombreAdmin);  
      labelBienvenido.setBounds(230,30,300,100);
      ...
      labelfooter = new JLabel("©2019 The Quilmes Company | Todos los derechos reservados");
    ...
    public void actionPerformed(ActionEvent e) {
	   ...
	   if (nombreTrabajador.equals ("") || AP.equals("") || AM.equals("") || Departamento.equals("") || Antiguedad.equals("")){
	    ...
	    getContentPane().setBackground(new Color (175,131,194));

        }
	if (e.getSource() == miVerde){
	    getContentPane().setBackground(new Color (88,121,26));
        }
	...
	if (e.getSource() == miSalir){
	   ...
	   JOptionPane.showMessageDialog(null, "Desarrollado por Alegre Diego R.");
